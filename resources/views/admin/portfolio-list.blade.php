        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{route('portfolio.create')}}" class="btn btn-primary btn-block">Yeni Portfolio Ekle</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            @foreach($list as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td>
                                        <a data-id="{{$item->id}}" class="btn btn-warning edit" href="{{route('portfolio.edit' , ['portfolio'=>$item->id])}}" >Düzenle<i class="fa fa-edit"></i> </a>
                                    </td>
